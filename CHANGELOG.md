...
- Bug fixes and other improvements
  ...
  - Mac: Fixed Apple Music API not working for songs with certain non-ASCII characters like "Ÿ" in "JAŸ-Z". This was due to a bug in cpp-httplib: [yhirose/cpp-httplib#2482](https://github.com/yhirose/cpp-httplib/issues/2482). Fixes [#864](https://github.com/ungive/discord-music-presence/issues/864)
  - Spotify: Fixed some songs not being found due to a Spotify API bug where newer releases are not found, when the album name is explicitly used to search, even though the album name matches exactly. See [#873](https://github.com/ungive/discord-music-presence/issues/873)
  - Improved reliability of the hint that shows at first launch of the app, which explains that Music Presence lives in the tray menu, by requiring it to be confirmed or closed at least once in order to not be shown again, since there were some reports of people never seeing this hint
